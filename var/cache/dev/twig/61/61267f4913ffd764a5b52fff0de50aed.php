...
class __TwigTemplate_b4466f1ed46b064c0c4f501aa4230134 extends Template
{
    ...
    public function block_body(array $context, array $blocks = []): iterable
    {
        ...
        // line 6
        yield "    <h1>Welcome to the Inventory Management System</h1>
...
";
    ...
    {
        return array (  122 => 17,  118 => 16,  110 => 11,  106 => 10,  100 => 6,  87 => 5,  64 => 3,  41 => 1,);
    }
...
{% block body %}
    ...
    <div>
        <h2>Manage Products</h2>
        <p><a href=\"{{ path('app_product_index') }}\">Go to Product List</a></p>
        <p><a href=\"{{ path('app_product_new') }}\">Create New Product</a></p>
    </div>

    <div>
        <h2>Manage Categories</h2>
        <p><a href=\"{{ path('app_category_index') }}\">Go to Category List</a></p>
        <p><a href=\"{{ path('app_category_new') }}\">Create New Category</a></p>
    </div>
{% endblock %}
", "index/index.html.twig", "/Applications/MAMP/htdocs/stockmyproducts/templates/index/index.html.twig");
    }
}
